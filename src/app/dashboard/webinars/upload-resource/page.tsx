...
const webinarId = searchParams?.get("webinarId") ?? "";
  ...
  const handleResourceTypeChange = (type: string) => {
    ...
    // Reset file input when switching to YouTube
  ...
  const handleMove = async (id: number, direction: "up" | "down") => {
    ...
    try {
      await fetch(`${BACKEND_URL}/webinar-resources/reorder`, {
        method: "PATCH",
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-start justify-start p-8   ">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-4xl w-full">
        ...
        {error && <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 rounded-lg">{error}</div>}
          ...
          {resourceForm.resourceType === "youtubelink" ? (
            <div>
              ...
              <input
                type="url"
                id="youtubelink"
                value={resourceForm.youtubelink || ""} // ✅ always string
            ...
            <div>
              ...
              <input
                ...
                key={resourceForm.resourceType} // ✅ reset input on type change
...
//   return (
// <div className="min-h-screen bg-gray-100 flex items-start justify-start p-8 font-sans">
//   <div className="bg-white rounded-xl shadow-lg p-8 max-w-4xl w-full">
//         <h2 className="text-3xl font-bold text-gray-800 mb-6">
//           Add Resources for Webinar ID: <span className="text-blue-600">{webinarId}</span>
//         </h2>
