  ...
  <div className="flex gap-2">
    <input
      ...
      onChange={(e) => {
        ...
        if (e.target.value !== profile.phone) setPhoneStatus("");
      }}
      className="flex-1 p-2 border rounded"
    />
    {form.phone === profile.phone ? (
      <div className="flex items-center gap-2 bg-green-50 text-green-700 px-3 py-2 rounded font-semibold border border-green-100">
  ...
  <div className="flex gap-2">
    <input
      ...
      onChange={(e) => {
        handleChange(e);
        // Reset verification if changed
        if (e.target.value !== profile.email) setEmailStatus("");
      }}
      className="flex-1 p-2 border rounded"
    />
    {form.email === profile.email ? (
      ...
      <button
        ...
        className="bg-green-600 text-white px-3 py-2 rounded"
      >
        {emailOtpVisible ? "Resend OTP" : "Verify"}
      </button>
    )}
  </div>
